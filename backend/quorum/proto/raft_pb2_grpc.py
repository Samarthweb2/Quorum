...
from quorum.proto import raft_pb2 as raft__pb2
...
class RaftServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.RequestVote = channel.unary_unary(
                '/quorum.raft.RaftService/RequestVote',
...
def add_RaftServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'quorum.raft.RaftService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('quorum.raft.RaftService', rpc_method_handlers)
